...
<NavBar />
<main class="p-5">
  <div class="full-width items-center justify-between px-5 md:px-7 md:flex">
    ...
    <div class="w-full md:w-1/2 p-3">
      <img src="/img/hero.png" width="100%" alt="" />
    </div>
  </div>
      ...
      <div class="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
        <div class="pt-2 text-gray-400 dark:text-gray-400">
          <svg
            ...
            ><defs
              ><clipPath id="clip0"
                ><path fill="#fff" d="M0 0H109.272V33H0z" /></clipPath
              ></defs
            ></svg
          >
        </div>
  ...
  <div class="p-5 md:flex items-center justify-center">
    ...
    <div class="w-full md:w-1/2">
      <h1
        class="text-4xl md:px-7 text-left font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white"
      >
        Highlight your benefits
      </h1>
      <p
        class="p-5 md:px-2 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300"
      >
        ...
        example along with some bullet points.h
      </p>
  ...
  <div
    class="container p-8 mx-auto xl:px-0 flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap "
  >
        ...
        <div class="w-full mt-5">
          <div class="flex items-start mt-8 space-x-3">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500 dark:text-gray-400">
                Sveltly-Fy is designed as a mobile first responsive template.
              </p>
            </div>
          </div>
          <div class="flex items-start mt-8 space-x-3">
            ...
            <div>
              <h4 class="text-xl font-medium text-gray-800 dark:text-gray-200">
                Powered by Sveltly-Fy &amp; TailwindCSS
              </h4>
              <p class="mt-1 text-gray-500 dark:text-gray-400">
          ...
          <div class="flex items-start mt-8 space-x-3">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500 dark:text-gray-400">
                Sveltly-Fy comes with a zero-config light &amp; dark mode.
              </p>
            </div>
          </div>
        </div>
