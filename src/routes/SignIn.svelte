<script>
    document.title = "Sveltly-Fy | Sign In your account"
</script>
<div class="lg:flex bg-white text-black p-10">
  <div class="lg:w-1/2 xl:max-w-screen-sm">
    <div
      class="py-12 bg-indigo-100 lg:bg-white flex justify-center
      lg:justify-start lg:px-12">
      <div class="cursor-pointer flex items-center">
        <div class="flex items-center justify-start">
          <img src="/favicon.png" width="60px" alt="" />
          <em class="font-bold text-indigo-200 dark:text-white">Sveltly-Fy</em>
        </div>
      </div> 
    </div>
    <div
      class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24
      xl:max-w-2xl">
      <h2
        class="text-center text-4xl text-indigo-900 font-display font-semibold
      ...
      <div class="mt-12">
        <form>
          <div>
            ...
            <input
              class="w-full text-lg py-2 border-b border-gray-300
          ...
          <div class="mt-8">
            <div class="flex justify-between items-center">
              ...
              <div>
                <a
                  class="text-xs font-display font-semibold text-indigo-600
          ...
          <div class="mt-10">
            <button
              class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full
              tracking-wide font-semibold font-display focus:outline-none
              focus:shadow-outline hover:bg-indigo-600 shadow-lg">
              Sign In now
            </button>
          </div>
        </form>
        <div
          class="mt-12 text-sm font-display font-semibold text-gray-700
          text-center">
  ...
  <div
    ...
    <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
      <svg
        ...
        <polygon
          points="296 377.66 298.773 382.463 301.545 387.265 296 387.265 290.455
          387.265 293.227 382.463 296 377.66"
          fill="#535461" />
        <polygon
